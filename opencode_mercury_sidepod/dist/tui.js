    ...
    api.command?.register(() => [
      {
        title: "Mortic: Focus sidepod",
        value: "mortic.focus",
        description: "Move keyboard control to Mortic.",
        category: "Mortic",
        keybind: "ctrl+x v",
        suggested: true,
        onSelect: focusMortic
      },
      {
        title: "Mortic: Return to prompt",
        value: "mortic.blur",
        description: "Leave Mortic focus mode.",
        category: "Mortic",
        hidden: !getFocused(),
        onSelect: blurMortic
      },
      {
        title: "Mortic: Push to Talk",
        value: "mortic.ptt",
        description: "Toggle push-to-talk.",
        category: "Mortic",
        onSelect: toggleArmed
      },
      {
        title: "Mortic: Transcript",
        value: "mortic.transcript",
        description: "Open or close the transcript popup.",
        category: "Mortic",
        onSelect: openTranscript
      },
      {
        title: "Mortic: Handoff",
        value: "mortic.handoff",
        description: "Open or close the handoff popup.",
        category: "Mortic",
